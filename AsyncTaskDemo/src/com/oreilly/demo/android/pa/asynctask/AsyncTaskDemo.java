...
public class AsyncTaskDemo extends Activity {
		...
		((Button) findViewById(R.id.start))
				.setOnClickListener(new View.OnClickListener() {
					...
					public void onClick(View v) {
						// initGame(
						new AsyncInitGame(dots, bg, game,
						// msg,
						// "basic");
								msg).execute("basic");
					}
	...
	/**
	 * Synchronous request to remote service DO NOT USE!!
	 * 
	 * @param dots
	 * @param bg
	 * @param game
	 ...
	 * @param level
	 */
	void initGame(View dots, Drawable bg, Game game, TextView resp, String level) {
