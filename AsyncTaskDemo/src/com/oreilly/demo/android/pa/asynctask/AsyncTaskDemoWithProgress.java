...
public class AsyncTaskDemoWithProgress extends Activity {
	...
	@SuppressLint("NewApi")
	private final class AsyncInit extends AsyncTask<String, Integer, String>
		...
		public AsyncInit(View dots, Drawable bg, Game game, TextView msg) {
			this.dots = dots;
			this.bg = bg;
			this.game = game;
			this.message = msg;
		...
		protected String doInBackground(String... args) {
			return ((1 != args.length) || (null == args[0])) ? null : game
					.initialize(args[0], this);
		}
