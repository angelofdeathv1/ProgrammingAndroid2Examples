...
public class AsyncTaskSample {
	 ...
	 * AsyncDBReq
	 */
	public class AsyncDBReq extends
			AsyncTask<PreparedStatement, Void, ResultSet> {
		/**
	 ...
	 * AsyncContentReq
	 */
	public class AsyncContentReq extends AsyncTask<URI, Void, HttpResponse> {
		/**
		 * @see android.os.AsyncTask#doInBackground(PreparedStatement[])
		 */
		@Override
	 ...
	 * @param vals
	 */
	public void initButton2(Button button, final Map<String, String> vals) {
		button.setOnClickListener(new View.OnClickListener() {
